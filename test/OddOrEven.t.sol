...
contract OddOrEven_Test is Deployer {
    ...
    function _play() private {
        ...
        vm.startPrank(user1);
        pool.approve(address(oddOrEven), 2 ether);
        oddOrEven.play{value: 0.01 ether}({
            numberOfRounds: 1,
    ...
    function test_play() public {
        ...
        (Game.GameParams memory params, bool isOdd) = oddOrEven.games(user1);
